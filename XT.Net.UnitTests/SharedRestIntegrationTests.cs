...
namespace XT.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IXTRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddXT(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IXTRestClient>().SpotApi.SharedClient;
        }

        private IXTRestClientFuturesApiShared GetFuturesRestClient()
        {
            ExchangeParameters.SetStaticParameter("XT", "SettleAsset", "usdt");
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<IXTRestClient>().UsdtFuturesApi.SharedClient;
        }
