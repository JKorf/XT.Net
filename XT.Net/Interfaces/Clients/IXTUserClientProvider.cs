...
namespace XT.Net.Interfaces.Clients
{
    ...
    public interface IXTUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, XTCredentials credentials, XTEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IXTRestClient GetRestClient(string userIdentifier, XTCredentials? credentials = null, XTEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IXTSocketClient GetSocketClient(string userIdentifier, XTCredentials? credentials = null, XTEnvironment? environment = null);
    }
}